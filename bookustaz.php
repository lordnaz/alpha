...
$_SESSION["login_id"] = 2;  // login id please uncomment if want session login id
...
?>
		...
		<section class="table-module-1" style="padding: 40px; background-color: #f8f8f8;">
			<div class="container">
				<form enctype='multipart/form-data' action="ustazfinder.php" method='post' onsubmit="return true"  accept-charset='UTF-8' name="key-landing" class="key-landing-wrapper ustaz-finder">
				...
				<div class="row padding-left-right-10">
                    <div class="col-sm-10">
                    	<div class="row">
	                        ...
	                        <div class="col-sm-2">
                                <input type="text" name="tarikh" class="form-control tarikh sync_box" key="tarikh" placeholder="" autocomplete="off" readonly />
	                        </div>
	                        <div class="col-sm-2">
		...
		<section style="background-color: #f8f8f8;">
			...
			<div class="container page1" style="margin:35px auto; background-color: #f8f8f8;">
		    	
		            <table class="table tablelayout display nowrap mytable" cellspacing="0" width="100%" id="mytable">
		                <thead class="thead">
		                    <tr>            
		                        <th><center>Ustaz/Ustazah</center></th>
		                        <th><center>Profil ringkas</center></th>
		                        <th><center>Perkhidmatan</center></th>
		                        <th><center>Kawasan</center></th>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="margin-top: 7px;">
                                ...
                                <input type="text" name="nameustaz" class="form-control nameustaz sync_box" key="nameustaz" placeholder="" autocomplete="off" readonly />  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" name="tarikh2" class="form-control tarikh2 sync_box" key="tarikh" id="tarikh2" placeholder="" autocomplete="off" readonly />                           
                            </div>
                            <div class="col-sm-2">
                ...
                <div class="row" id="post">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" style="margin-top: 7px;">
                                <!-- <label class="nameustaz"></label> -->
                                <input type="text" name="nameustaz2" class="form-control nameustaz2 sync_box" key="nameustaz" placeholder="" autocomplete="off" readonly />  
