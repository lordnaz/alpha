...
<html lang="en" itemscope itemtype="http://schema.org/Product">
    <head>
		...
		<!-- <link href="style-config.css" rel="stylesheet" type="text/css"> -->
    </head>
...
?>
                <!-- <div class="navbar navbar-default navbar-static-top" style="background-image: url('<?php echo $profiledata["background"]; ?>'); background-blend-mode: overlay; background-size: cover; background-color: #7820db; opacity:0.9; background-repeat:no-repeat">
                    <div> -->
        <section class="organization-dashboard-wrapper" style="background-image: url('<?php echo $profileData["background"]; ?>'); background-attachment: fixed; background-position: center; background-repeat: no-repeat;">
...
?>
						...
						<li class="nav-item">
							<a class="nav-link tr" key="faq" href="javascript:;">
								
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link go-to tr" key="contact" go-to="contact" href="javascript:;">
					...
					<div class="col-md-3">
						<div class="personal-wrapper">
							...
							<div class="personal-picture">
								<div class="padder">
									<span class="personal profile-image" style="background: url('<?php echo $profileData["image"]; ?>') no-repeat top center; background-size: cover;">									
									</span>
								</div>
							</div>
...
?>
							...
							<span class="personal-base">
								Location: <?php echo $profileData["area"].", ".$profileData["state"]; ?>
							</span>						
						</div>						
					</div>
					<div class="col-md-9">
...
<center>
<span class="white-color">Pilihan Penceramah:</span>
</center>
<div class="well well-design" style="background-color:transparent">
...
<div class="col-sm-2 ">
<a href="#x"><img src="image\SE1.png" alt="Image" class="center-block img-responsive img-thumbnail"></a>
</div>
<div class="col-sm-2">
<a href="#x"><img src="image\SE3.png" alt="Image" class="center-block img-responsive img-thumbnail"></a>
</div>
<div class="col-sm-2">
<a href="#x"><img src="image\SE4.png" alt="Image" class="center-block img-responsive img-thumbnail"></a>
</div>
<div class="col-sm-2">
<a href="#x"><img src="image\SE5.png" alt="Image" class="center-block img-responsive img-thumbnail"></a>
</div>
<div class="col-sm-2">
<a href="#x"><img src="image\SE6.png" alt="Image" class="center-block img-responsive img-thumbnail"></a>
</div>
<div class="col-sm-2">
<a href="#x"><img src="image\SE6.png" alt="Image" class="center-block img-responsive img-thumbnail"></a>
</div>
...
<a class="btn btn-default btn-personal hidden-lg hidden-md" style="margin-top:-10px">Lanjutan</a>
</center>
<br>
<!--/well-->
</div>
...
?>
		<section class="side-nav">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-2 no-left-padded">
		...
		<footer class="container-fluid">
			...
			<div class="row">
				<div class="col-sm-3 hidden-xs">
					<a href="javascript:;">
							<span class="tr" key="footer1">
								
							</span>
						</a>
						<a href="javascript:;">
							<span class="tr" key="footer2">
								
							</span>
						</a>
						<a href="javascript:;">
							<span class="tr" key="footer3">
								
							</span>
						</a>
						<a href="javascript:;">
							<span class="tr" key="footer4">
								
							</span>
						</a>
				</div>
				<div class="col-sm-6 text-center address">
					<span class="tr" key="footer5">
						
					</span>
					<span class="hidden-xs tr" key="" >
						SauceCode Studio Sdn. Bhd. (1227571-M)
					</span>
					<span class="hidden-sm hidden-md hidden-lg tr" key="" >
						SauceCode Studio Sdn. Bhd.
					</span>
				</div>
				<div class="col-sm-3 text-right hidden-sm-down">
					<!-- <div class="row">
					...
					<div class="row">
						<div class="col-md-12 hidden-xs text-right" id="parent">
