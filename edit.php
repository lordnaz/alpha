...
<html lang="en" itemscope itemtype="http://schema.org/Product">
	...
	<section class="registration container">
		<div class="row">
			<div class="col-sm-12">
				<h1 class="text-center tr" key="edit1">
...
?>
		...
		<script type="text/javascript">
	  		...
	  		$(document).ready(function(){
	  			...
	  			$(".organization_registration_form").css("display","none"); 
	  			$(".expert_registration_form").css("display","block");
	            ...
	            $(".state3").change(function (){
	                ...
	                $("select.area3").empty();
	                $("select.area3").data("selectBox-selectBoxIt").add({ value: "", text: "Pilih Daerah" });
	            ...
	            $(".title2 option[value='1']").prop('selected', true);
	            $("select.title2").data("selectBox-selectBoxIt").refresh();
	            $(".fullname").val("Hazim Noh");
